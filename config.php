...
$mysql_tables['config'] = array(
    ...
    'plex_thumbs'           => 'int(1) DEFAULT 1',
    'plex_posters'          => 'int(1) DEFAULT 1',
    'plex_fanarts'          => 'int(1) DEFAULT 1',
    'plex_exthumbs'         => 'int(1) DEFAULT 1',
    'plex_exthumbs_q'       => 'varchar(10) DEFAULT "853x480"',
    'plex_auto_conf_remote' => 'int(1) DEFAULT 0',
    'plex_master'           => 'int(1) DEFAULT 0',
    'plex_host'             => 'varchar(30) DEFAULT ""',
    'plex_port'             => 'varchar(5) DEFAULT ""',
    'plex_login'            => 'varchar(30) DEFAULT ""',
    'plex_pass'             => 'varchar(30) DEFAULT ""',
